    ...
    return (
        <div>
            <div className="pinning__container">
                <div className="pinning__header">
                    <h1 className="pinning__h1">Pin Your Files</h1>
                    <p className="pinning__p">
                        Pin your files to IPFS using other different pinning services
                    </p>
                </div>
                ...
                <form
                    onSubmit={(e) => {
                        ...
                        {
                            renderState() != "pick"
                                ? renderPin(inputValue)
                                : handleErrorNotification2()
                        }
                    }}
                    className="pinning__input"
                >
                    <input
                        type="text"
                        required
                    ...
                    <div className="enterbutton__div__pinning">
                        <button disabled={state} className="enter__button__pinning">
                            {state ? (
                                <div className="loader"></div>
                            ) : (
                                <span className="button__text">Pin</span>
                            )}
                        </button>
                    </div>
                </form>

                <div className="pinning__services">
                    <div className="pinning__service">
                        {renderState() == "pick" ? (
                            <div>Select a pinning service to view your files</div>
                        ) : (
                            ""
                        )}
                            ...
                            <div className={renderClass()}>
                                ...
                                >
                                    <div className="pinning__service__header">
                                        <h1 className="pinning__service__h1">
                                            Your Pinata pinned files
                                        </h1>
                                    </div>
                                    ...
                                    <div className="title__button__div">
                                        <button
                                            onClick={() => navigate("allPinataFiles")}
                        ...
                        {renderState() == "infura" ? (
                            <div className={renderClass()}>
                                ...
                                >
                                    ...
                                    <div className="title__button__div">
                                        <button
                                            onClick={() => navigate("allInfuraFiles")}
                                            className="title__button"
                                        >
                                            View All
                                        </button>
                        ...
                        {renderState() == "filebase" ? (
                            <div className={renderClass()}>
                                ...
                                >
                                    ...
                                    <div className="title__button__div">
                                        <button
                                            onClick={() => navigate("allFilebaseFiles")}
                                            className="title__button"
                                        >
                                            View All
                                        </button>
